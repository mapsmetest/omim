...
prebuild_static_libs := osrm protobuf tomcrypt jansson minizip fribidi freetype expat base normalize coding geometry anim platform graphics indexer storage search routing gui render map stats_client succinct opening_hours torrent
...
LOCAL_STATIC_LIBRARIES := map render gui routing search storage indexer graphics platform anim geometry coding normalize base expat freetype fribidi minizip jansson tomcrypt protobuf osrm stats_client succinct opening_hours torrent
