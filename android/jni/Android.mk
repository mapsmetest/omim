...
prebuild_static_libs := osrm protobuf tomcrypt jansson minizip fribidi freetype expat base normalize coding geometry platform indexer storage search routing drape drape_frontend map stats_client succinct opening_hours
...
LOCAL_STATIC_LIBRARIES := map drape_frontend routing search storage indexer drape platform geometry coding normalize base expat freetype fribidi minizip jansson tomcrypt protobuf osrm stats_client succinct opening_hours
